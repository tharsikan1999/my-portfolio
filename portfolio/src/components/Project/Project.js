                   ...
                   if (projectIndex === key) {
                    return (
                        <React.Fragment key={key}>
                           <div className="  ">
                             <img className="border mb-2" src={e.imgOne} alt="" />
                             <img className="border " src={e.imgTwo} alt="" />            
                           </div>
                           <div className="  ">
                             <img className="border" src={e.imgThree} alt="" />
                             <img className="border mt-2" src={e.imgFour} alt="" />            
                           </div>
                        </React.Fragment>
        );
      }
