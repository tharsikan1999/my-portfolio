                    ...
                    <div className="grid lg:grid-cols-12 grid-cols-1 items-center">
                        <div className="lg:col-span-6">
                            <div className="text-center lg:text-start mb-14 lg:mb-0">
                                <h6 className="uppercase text-sm md:text-base tracking-[2px] font-semibold mb-5 md:mb-8">👋, My name is Tharsikan</h6>
                        ...
                        <div className="lg:col-span-6">
                            <div className="home-image text-center ">
                                <img src={home_banner} title="" alt="" className="rounded-3xl"/>
                            </div>
                        </div>
                    </div>
                </div>
