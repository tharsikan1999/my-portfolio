                ...
                <div className="container">
                    <div className="grid lg:grid-cols-12 grid-cols-1 items-center">
                        ...
                        <div className="lg:col-span-6 lg:pl-12">
                            <h3 className="font-semibold text-[26px] md:text-[40px] leading-[1.2] mb-6 normal-case">I'm a Freelancer Front-end Developer with over 3 years of experience.</h3>
                            <p className="text-base md:text-lg text-slate-700/90">I'm a Freelancer Front-end Developer with over 3 years of experience. I'm from San Francisco. I code and create web elements for amazing people around the world. I like work with new people. New people new Experiences.</p>
